            ...
            >
                <SwiperSlide>
                    <div className="relative bg-white border-3 border-central rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                            <div className="w-15 h-15 sm:w-20 sm:h-20 rounded-full bg-gradient-to-b from-primary to-midnight border-4 border-central flex items-center justify-center shadow-md">
                                <Service_01 />
                            </div>
                        </div>
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-primary  mb-2 text-pretty">XÉT NGHIỆM<br /> HÓA SINH</h3>
                    ...
                    <div className="relative bg-white border-3 border-central bg-gradient-to-b from-primary to-midnight rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                            <div className="w-15 h-15 sm:w-20 sm:h-20 rounded-full bg-white border-4 border-midnight flex items-center justify-center shadow-md">
                                <Service_02 />
                            </div>
                        </div>
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-white  mb-2 text-pretty">XÉT NGHIỆM<br /> VI SINH</h3>
                ...
                <SwiperSlide>
                    <div className="relative bg-white border-3 border-central bg-gradient-to-b from-primary to-midnight rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-white  mb-2 text-pretty">XÉT NGHIỆM <br /> HUYẾT HỌC</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-white">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                    <div className="relative bg-white border-3 border-central rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-primary  mb-2 text-pretty">XÉT NGHIỆM <br className="hidden md:block" /> SINH HỌC PHÂN TỬ</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-primary">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="relative bg-white border-3 border-central rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-primary  mb-2 text-pretty">XÉT NGHIỆM<br /> MIỄN DỊCH</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-primary">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                    <div className="relative bg-white border-3 border-central bg-gradient-to-b from-primary to-midnight rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-white  mb-2 text-pretty">XÉT NGHIỆM<br /> GIẢI PHẪU BỆNH</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-white">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="relative bg-white border-3 border-central bg-gradient-to-b from-primary to-midnight rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%]">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-white  mb-2 text-pretty">XÉT NGHIỆM<br /> TẠI NHÀ</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-white">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                    <div className="relative bg-white border-3 border-central rounded-2xl pt-5 md:pt-12 pb-5 text-center shadow-sm mx-2 my-8 md:m-10 w-[85%] md:w-[80%] ">
                        ...
                        <div className="mt-10">
                            <h3 className="font-fz-poppins font-bold text-md sm:text-lg uppercase text-primary  mb-2 text-pretty">GÓI<br /> XÉT NGHIỆM</h3>
                            <p className="font-fz-poppins font-midium text-sm lg:text-md text-primary">Xem thêm <span>»</span></p>
                        </div>
                    </div>
                </SwiperSlide>
