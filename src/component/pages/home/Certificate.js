            ...
            <div className="container mx-auto py-1 flex flex-col lg:flex-row justify-between items-center">
                ...
                >
                    <motion.h1
                        ...
                        className="md:text-2xl text-xl font-bold text-white mb-4 uppercase text-outline-4 text-pretty"
                        variants={itemVariants}
                    >
                    ...
                    <motion.p
                        className="text-sm sm:text-base mb-6 leading-relaxed text-pretty"
                        variants={itemVariants}
                    >
                    ...
                    <motion.ul
                        className="space-y-4 text-sm sm:text-base mt-6 text-pretty"
                        role="list"
                        variants={containerVariants}
                    >
