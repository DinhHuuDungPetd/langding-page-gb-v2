        ...
        <section className="relative page py-12 px-4 sm:px-6">
            <div className="relative z-10 mx-auto flex flex-col xl:flex-row gap-10 max-w-7xl">
                ...
                <div className="w-full xl:flex-1">
                    ...
                    <p className="text-sm md:text-base xl:text-base font-medium mb-4">
                    ...
                    <form className="space-y-4 text-[16px] ">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2">
                            <label className="text-primary md:w-1/5 font-semibold text-sm md:text-base xl:text-base">
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <label htmlFor="note" className="text-primary md:w-1/5 font-semibold text-sm md:text-base xl:text-base">
