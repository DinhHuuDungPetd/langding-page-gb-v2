...
export default function AppFooter() {
    return (
        <footer className="bg-gradient-to-b from-primary to-midnight text-white px-5 md:px-16 py-10">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-x-8 gap-y-2 items-start">
                ...
                <div className="sm:col-span-1 xl:col-span-4 text-base mx-auto text-center sm:text-left">
                    <ul className="space-y-2 px-10 hidden sm:block mb-4">
                        {[
                            { name: 'Trang chủ', href: '/' },
                    ...
                    <div className="bg-white text-primary font-bold text-center py-4 px-8 rounded-md w-fit text-base">
                        Thời gian hoạt động<br />
                        <span className="font-medium text-base text-balance">Thứ 2 đến Chủ Nhật: 7h00 - 21h00</span>
                    </div>
                </div>
